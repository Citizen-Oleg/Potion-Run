...
public static bool FORCE_GLES_COMPATIBILITY = true;
        ...
        [SerializeField]
        [ColorUsage(true)]
        private Color _liquidColor1 = new Color(0, 1, 0, 0.1f);
        ...
        public float LiquidLevelPos => liquidLevelPos;
        ...
        public void MoveToLiquidSurface(Transform transform, BuoyancyEffect effect, Transform root = null, float dampen = 0.8f) {
            ...
            if (effect == BuoyancyEffect.Simple) {
                position.y = liquidLevelPos + 0.25f;
            ...
            if (effect == BuoyancyEffect.PositionOnly) {
                ...
                float y1 = liquidLevelPos + turbulence1 + 0.25f;
                position.y = y1;
                transform.position = position;
                return;
            }
            ...
            if (effect == BuoyancyEffect.PositionAndRotation) {
                ...
                root.transform.right = Vector3.Lerp(root.transform.right, n, dampen);
            }
        }
